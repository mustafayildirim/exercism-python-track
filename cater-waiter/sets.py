...
def separate_appetizers(dishes, appetizers):
    ...
    de_dupped_dishes = set(dishes)
    de_dupped_appetizers = set(appetizers)
    for key in de_dupped_appetizers:
        if key in de_dupped_dishes:
            de_dupped_dishes.remove(key)

    return de_dupped_dishes
